<?php function _themename_comment_callback($comment, $args, $depth) {
    ...
    <div class="c-comment__content">
      ...
      <a class="c-comment__time" href="<?php echo esc_url( get_comment_link($comment, $args))?>">
        <time datetime="<?php comment_time('c')?>">
          <?php
            printf(esc_html__('%s ago', '_themename'),
      ...
      <?php if($comment->comment_approved == '0'){ ?>
        <p class="c-comment__awaiting-moderation"><?php esc_html_e( 'Your comment is awaiting approval', '_themename');?></p>
      <?php } ?>
      <?php
