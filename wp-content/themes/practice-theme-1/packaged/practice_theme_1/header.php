...
<!-- Adds language attributes, charset and title(wp_head) dynamically -->
  ...
  <body <?php body_class(); ?>>
    <a class="u-skip-link" href="#content"><?php esc_attr_e('Skip to Content', 'practice_theme_1'); ?></a>
    ...
    <header role="banner" class="u-margin-bottom-40">
      ...
      <div class="c-navigation">
        <div class="o-container">
          <nav class="header-nav" role="navigation" aria-label="<?php esc_html_e('Main-Navigation', 'practice_theme_1') ?>">
            <?php
