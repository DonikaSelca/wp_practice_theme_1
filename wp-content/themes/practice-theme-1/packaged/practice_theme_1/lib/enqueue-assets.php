...
// <!-- Includes stylesheets, jquery and scripts into project. -->
  function practice_theme_1_assets(){
    ...
    wp_enqueue_style('practice_theme_1-stylesheet', get_template_directory_uri().
    '/dist/assets/css/bundle.css', array(), '1.0.0', 'all');
    include(get_template_directory() . '/lib/inline-css.php');
    wp_add_inline_style('practice_theme_1-stylesheet', $inline_styles);
    ...
    wp_enqueue_script('practice_theme_1-scripts', get_template_directory_uri().
  ...
  add_action('wp_enqueue_scripts', 'practice_theme_1_assets');

// First function is for the main page and the one bellow is for the wp admin page
  function practice_theme_1_admin_assets(){
    wp_enqueue_style('practice_theme_1-admin-stylesheet', get_template_directory_uri().
    '/dist/assets/css/admin.css', array(), '1.0.0', 'all');
    wp_enqueue_script('practice_theme_1-admin-scripts', get_template_directory_uri().
    '/dist/assets/js/admin.js', array(), '1.0.0', true);
  }
  add_action('admin_enqueue_scripts', 'practice_theme_1_admin_assets');

  function practice_theme_1_customize_preview_js(){
    wp_enqueue_script('practice_theme_1-customize-preview', get_template_directory_uri().
    '/dist/assets/js/customize-preview.js', array('customize-preview', 'jquery'), '1.0.0', true);
    include(get_template_directory() . '/lib/inline-css.php');
    wp_localize_script( 'practice_theme_1-customize-preview', 'practice_theme_1', array('inline-css' => $inline_styles_selectors));
  }

  add_action('customize_preview_init', 'practice_theme_1_customize_preview_js');
?>
